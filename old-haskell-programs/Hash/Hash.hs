...
--exists :: IntHash -> Int -> Bool
exists :: StringToStringHash -> StringToString -> Bool
...
insert :: StringToStringHash -> StringToString -> StringToStringHash
...
remove :: StringToStringHash -> StringToString -> StringToStringHash
...
get_value :: StringToStringHash -> StringToString -> [StringToString]
...
--replace :: IntHash -> Int -> IntHash
replace_or_add :: StringToStringHash -> StringToString -> StringToStringHash
